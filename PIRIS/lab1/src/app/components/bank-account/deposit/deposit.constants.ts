...
export const DEPOSITS: Deposit[] = [
  {
    ...
    minDurationTime: getDurationDate(new Date(), { month: 3 }),
    maxDurationTime: getDurationDate(new Date(), { year: 3 }),
    minAmount: 1000,
    percent: 5,
...

  {
    ...
    minDurationTime: getDurationDate(new Date(), { month: 1 }),
    maxDurationTime: getDurationDate(new Date(), { year: 3 }),
    minAmount: 500,
    percent: 1.2,
  ...
  },
  {
    ...
    minDurationTime: getDurationDate(new Date(), { year: 1 }),
    maxDurationTime: getDurationDate(new Date(), { year: 3 }),
    minAmount: 20000,
    percent: 8.5,
    type: DepositType.Revocable,
...

  {
    name: 'Beneficial',
    currencyType: CurrencyType.USD,
    minDurationTime: getDurationDate(new Date(), { year: 5 }),
    maxDurationTime: getDurationDate(new Date(), { year: 10 }),
    minAmount: 10000,
    percent: 4.5,
    type: DepositType.Irrevocable,
  },
